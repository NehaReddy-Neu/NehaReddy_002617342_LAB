...
public class ViewJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        fieldOId = new javax.swing.JTextField();
        ...
        fieldOId.setEnabled(false);
        add(fieldOId, new org.netbeans.lib.awtextra.AbsoluteConstraints(168, 74, 97, -1));
    ...
    private void viewObsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewObsBtnActionPerformed
        ...
        if(selectedRow >= 0){
            ...
            //fill all textfields
            fieldOId.setText(String.valueOf(this.selectedObs.getObservationId()));
    ...
    private void updObsBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updObsBtnActionPerformed
        // TODO add your handling code here:
       if( !fieldOId.getText().isEmpty()){ 
        //update the observation object
        
            Observation o = this.application.getHistory().findObservation(Integer.valueOf(fieldOId.getText()));
    ...
    private javax.swing.JTextField fieldOId;
